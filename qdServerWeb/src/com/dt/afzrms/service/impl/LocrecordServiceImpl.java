...
public class LocrecordServiceImpl implements LocrecordService {
	...
	public PageVo<LocrecordVo> findList(Integer pageNo, Integer pageSize, String deviceId, Date beginTime, Date endTime)
	 {
		String sql = "select id,device_id,x,y,speed,direction,height,distance,DATE_FORMAT(gps_time,'%Y-%m-%d %T') "
				+ "gps_time,IFNULL(CAST(device_status AS CHAR),0) device_status ,IFNULL(CAST(alarm_type AS CHAR),0)  alarm_type "
