	...
	GAS.VerchileTypManager = Ext.extend(Ext.Window, {
		constructor : function(config) {
			...
			this.updateUrl = GAS.config["globalProxy"]
					+ "/vehicleBrand/update?_dc=" + new Date().getTime(); // 修改的URL地址
			this.addUrl = GAS.config["globalProxy"] + "/vehicleBrand/add?_dc="
			...
			GAS.VerchileTypManager.superclass.constructor
		...
		getFormPanel : function() {
			if (!this.formPanel) {
				...
				var list = [this.primaryId, this.nameFiled, this.desc,
						this.remarker];
