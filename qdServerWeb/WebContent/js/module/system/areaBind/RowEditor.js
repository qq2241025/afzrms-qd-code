...
Ext.ux.grid.RowEditor = Ext.extend(Ext.Panel, {
	...
	stopEditing : function(saveChanges) {
		...
		if (!this.getRowEditValid()) {
			this.hide();
		}
	},
	getRowEditValid : function() {
		return this.GridValid || false;
	},
	setRowEditValid : function(flag) {
		this.GridValid = flag;
	},
	verifyLayout : function(force) {
		...
		this.fireEvent("showEditor", this, this.rowIndex, this.btns);
	},
