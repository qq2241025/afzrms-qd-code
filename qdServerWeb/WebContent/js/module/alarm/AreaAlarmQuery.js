(function() {
	/**
	 * 越界报警查询 * zhengang.he@autonavi.com
	 * 
	 * @param {Object}
	...
	GAS.AreaAlarmQuery = Ext.extend(Ext.Panel, {
		constructor : function(config) {
			...
			this.alarmAreaQueryUrl = GAS.config["globalProxy"]
					+ "/tj/areaAlarm?_dc=" + new Date().getTime();
			Ext.apply(this, {
						border : false,
						frame : false,
						layout : "fit",
		...
		getGridStore : function() {
			if (!this.gridstore) {
				this.gridstore = new Ext.data.JsonStore({
							autoLoad : true,
							fields : ["deptName", "termName", "simcard", "id",
									"alarmSubType", "distance", "gpsTime",
									"height", "speed", "direction",
									"deviceStatus", "alarmType", "deviceId"],
							root : 'data',
							totalProperty : 'total',
