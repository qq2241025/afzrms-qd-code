(function() {
	...
	GAS.MainLog = {
		...
		themeSetting : function(name, clspath, days) {
			var head = document.getElementsByTagName("head")[0], links = document
					.getElementsByTagName("link"), len = links.length;
			// 加载样式文件
		...
		ChangePassword : function() {
			...
			var renewpwd = new Ext.form.TextField({
						...
						validator : function() {
							var value = this.getValue();
							var flag = GAS.MainLog.password(value, newpwd
											.getValue());
							return flag;
						}
					});
