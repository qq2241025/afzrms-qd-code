(function(){
	 ...
	 * QQ:1023553356
	 */
	GAS.VechileBrand = Ext.extend(Ext.Panel,{
	      constructor : function(config) {
	      	    config = config || {};
	      	    this.pageSize = 20;
	      	    
	      	    this.vehicleListUrl = GAS.config["globalProxy"]+"/vehicleBrand/list?_dc="+new Date().getTime(); //查询接口
	      	    this.deleteUrl      = GAS.config["globalProxy"]+"/vehicleBrand/delete?_dc="+new Date().getTime(); //删除接口
	      	    
	      	    this.verTypeMangerUrl = "js/module/system/vechileBrand/VerchileBrandManager.js"; //加载的URL地址
	      	    Ext.apply(this,{
	      	        border : false,
					frame  : false,
					layout : "fit",
				...
				GAS.VechileBrand.superclass.constructor.apply(this, arguments);
		   },
		   //主面板
		...
		getGridStore : function() {
		     if(!this.gridstore){
		     	 this.gridstore= new Ext.data.JsonStore({
		     		autoLoad : true,
				 	fields   : ["id","createTime","remark","description","name","createBy"],
				 	root     : 'data', 
					totalProperty: 'total', 
