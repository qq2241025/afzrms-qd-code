...
Ext.ux.form.TimePickerField=function(config) {
	this.dataTimeValue = config["dataTime"] || new Date(); 
	   ...
	   listeners: {
	    ...
	    afterrender: {
	     fn: function(spinner) {
	       ...
	       spinner.wrap.applyStyles('margin-left:2px');
	     },
	     single: true
	    }
	   }
...
Ext.DateTimePicker = Ext.extend(Ext.DatePicker, {
    ...
    setValue : function(value){
        ...
        if (!this.tf){
            ...
            this.tf = new Ext.ux.form.TimePickerField(dataTime);
...
Ext.form.DateTimeField = Ext.extend(Ext.form.DateField, {
    ...
    onTriggerClick : function(){
        ...
        this.fireEvent("show",this,this.menu);
    }
});
