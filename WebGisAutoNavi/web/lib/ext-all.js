...
Ext.Element.addMethods(function() {
	...
	return {
		...
		getHeight : function(H) {
			var G = this, J = G.dom, I = Ext.isIE9m
		...
		getWidth : function(G) {
			var H = this, J = H.dom, I = Ext.isIE9m
...
Ext.EventManager = function() {
	var z, p, j = false, l = Ext.isGecko || Ext.isWebKit || Ext.isSafari
			|| Ext.isIE10p, o = Ext.lib.Event, q = Ext.lib.Dom, c = document, A = window, r = "DOMContentLoaded", t = "complete", g = /^(?:scope|delay|buffer|single|stopEvent|preventDefault|stopPropagation|normalized|args|delegate)$/, u = [];
	function n(E) {
		...
		if (Ext.isDefined(a) || Ext.isDefined(b)) {
			if (!this.collapsed) {
				...
				if (this.footer) {
					...
					if (this.fbar) {
						this.fbar.setSize(Ext.isIE9m ? (a - this.footer
...
Ext.ColorPalette = Ext.extend(Ext.Component, {
	...
	onRender : function(b, a) {
		...
		var c = this.tpl
				|| new Ext.XTemplate('<tpl for="."><a href="#" class="color-{.}" hidefocus="on"><em><span style="background:#{.}" class="x-unselectable" unselectable="on">&#160;</span></em></a></tpl>');
	...
	Ext.dd.DragDropMgr = function() {
		...
		return {
			...
			fireEvents : function(o, r) {
				var q = this, l = q.dragCurrent, s = o.getPoint(), c, u, g = [], b = [], h = [], m = [], k = [], d = [], p, j, n, t;
				if (!l || l.isLocked()) {
					return
				}
				...
				for (t in l.groups) {
					...
					for (j in q.ids[t]) {
						c = q.ids[t][j];
						if (q.isTypeOfDD(c) && (u = c.getEl()) && (c.isTarget)
								&& (!c.isLocked())
								&& ((c != l) || (l.ignoreSelf === false))) {
...
Ext.dd.DragTracker = Ext.extend(Ext.util.Observable, {
			...
			onMouseMove : function(g, d) {
				...
				g.preventDefault();
				var c = g.getXY(), a = this.startXY;
				this.lastXY = c;
				if (!this.active) {
					if (Math.abs(a[0] - c[0]) > this.tolerance
...
Ext.tree.TreeSorter = Ext.extend(Object, {
	constructor : function(a, c) {
		...
		this.sortFn = function(o, m) {
			...
			var n = k[i], l = j[i], q = d ? d(n, o) : (b ? n : n.toUpperCase()), p = d
					? d(l, m)
					: (b ? l : l.toUpperCase());
			if (q < p) {
				return e ? 1 : -1
		...
		this.keyNav = new Ext.KeyNav(this.el, {
			...
			doRelay : function(c, b, a) {
				if (a == "down" || this.scope.isExpanded()) {
					...
					if ((((Ext.isIE9 && Ext.isStrict) || Ext.isIE10p) || !Ext.isIE)
	...
	handleHdDown : function(i, j) {
		if (Ext.fly(j).hasClass("x-grid3-hd-btn")) {
			...
			var k = this.cm, g = this.findHeaderCell(j), h = this
					.getCellIndex(g), d = k.isSortable(h), c = this.hmenu, b = c.items, a = this.headerMenuOpenCls, l;
			this.hdCtxIndex = h;
...
Ext.extend(Ext.grid.GridDragZone, Ext.dd.DragZone, {
	...
	getDragData : function(g) {
		var c = Ext.lib.Event.getTarget(g), i, h = this.view.findRowIndex(c), b, a, d;
		if (h !== false) {
