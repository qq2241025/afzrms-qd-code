...
public abstract class BaseController extends AbstractController {
	...
	protected Integer currentUserRoleId(HttpServletRequest request) {
	 ...
	 //时间转换
    public static boolean isDateYMD(String time){
    	 boolean falg = false;
    ...
    //时间转换
    public  boolean isDateYMDHMS(String time){
   	 boolean falg = false;
   	 if(!StringUtils.isEmpty(time)){
    ...
    public  Map<String, Object> getSuccessResult(String msg){
     ...
     //抛出异常的工具类方法
     public  Map<String, Object> getErrorResult(String msg){
     	Map<String, Object> result = new HashMap<String, Object>();
     ...
     //没有结果的工具类型方法
     public  Map<String, Object> getEmptyResult(){
     	Map<String, Object> result = new HashMap<String, Object>();
     	result.put("success", true);
     	result.put("result", new ArrayList<Object>());
     	return result;
     ...
     //没有获取用户登录信息的结果集工具类方法
     public  Map<String, Object> getNullUserResult(){
     	Map<String, Object> result = new HashMap<String, Object>();
     	result.put("success", true);
     	result.put("msg", Const.MSG_USER_NULL);
     	result.put("result", new ArrayList<Object>());
     	return result;
     }
}
