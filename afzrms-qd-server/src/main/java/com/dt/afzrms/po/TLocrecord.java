...
// Generated 2015-3-18 15:06:21 by Hibernate Tools 3.4.0.CR1
...
/**
 * TLocrecord generated by hbm2java
 */
@Entity
@Table(name = "T_LOCRECORD", catalog = "qdafz")
public class TLocrecord implements java.io.Serializable {
	...
	public TLocrecord(Date inputTime) {
		this.inputTime = inputTime;
	}

	public TLocrecord(String deviceId, Double x, Double y, Float speed, Float direction, Float height, Float distance,
			Date gpsTime, Date inputTime, byte[] deviceStatus, String status, byte[] alarmSubType, byte[] alarmType) {
