(function(){
    ...
    Ext.form.CheckComBox = Ext.extend(Ext.form.ComboBox, {  
        checkField: 'checked',  
        separator: ',',  
        initComponent: function() {  
            Ext.form.CheckComBox.superclass.initComponent.call(this);  
            this.tpl = ['<tpl for=".">',  
                        '<div class="x-combo-list-item">',  
                        '<div class="ux-CheckComBox-selectall-icon ux-CheckComBox-iconux-CheckComBox-icon-{[values.' + this.checkField + '?"checked":"unchecked"]}"',
        ...
        initEvents: function() {  
            Ext.form.CheckComBox.superclass.initEvents.apply(this, arguments);  
    ...
    Ext.reg('CheckComBox', Ext.form.CheckComBox);  
