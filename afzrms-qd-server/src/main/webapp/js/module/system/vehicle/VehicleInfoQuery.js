	...
	GAS.VehicleInfoQuery = Ext.extend(Ext.Panel,{
	      constructor : function(config) {
	      	    ...
	      	    this.vehicleListUrl = GAS.config["globalProxy"]+"/terminal/maplist?_dc="+new Date().getTime(); //查询接口
	      	    this.deleteUrl      = GAS.config["globalProxy"]+"/terminal/delete?_dc="+new Date().getTime(); //删除接口
		...
		getGridStore : function() {
		     if(!this.gridstore){
		     	 this.gridstore= new Ext.data.JsonStore({
		     		autoLoad : true,
				 	fields   : ["id","name", "vehicleNumber", "deptId", "deptName", "vehicleType", "vehicleBrand",
							"simcard", "deviceId", "locateType","vehicleTypeName","vehicleBrandName","protocalTypeName",
							"protocalType","vehicleTypeId","vehicleBrandId","createTime","remark","driverName","driverPhone"],
				 	root     : 'data', 
					totalProperty: 'total', 
