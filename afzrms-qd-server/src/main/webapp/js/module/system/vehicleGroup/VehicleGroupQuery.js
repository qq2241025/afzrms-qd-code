(function(){
	...
	GAS.VehicleGroupQuery = Ext.extend(Ext.Panel,{
	      constructor : function(config) {
	      	    ...
	      	    this.vechileGroupListUrl    = GAS.config["globalProxy"]+"/vehicleGroup/list?_dc="+new Date().getTime(); //查询接口
	      	    this.deleteUrl              =  GAS.config["globalProxy"]+"/vehicleGroup/delete?_dc="+new Date().getTime(); //删除接口
	      	    this.vechileGroupManagerUrl = "js/module/system/vehicleGroup/VehicleGroupManager.js"; //加载的URL地址
	      	    this.groupListUrl = GAS.config["globalProxy"]+"/vehicleGroup/deviceIdList?_dc="+new Date().getTime(); //查询组列表的URL
		...
		getGridStore : function() {
		     if(!this.gridstore){
		     	 this.gridstore= new Ext.data.JsonStore({
		     		autoLoad : true,
				 	fields   : ["id","createTime","remark","name","uses","createBy"],
				 	root     : 'data', 
					totalProperty: 'total', 
