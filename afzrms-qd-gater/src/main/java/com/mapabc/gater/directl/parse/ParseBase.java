...
public class ParseBase implements Cloneable {
	...
	private String alarmStartTime;//报警持续时间-开始时间
	private String alarmEndTime;//报警持续时间-结束时间
	...
	public void resetObject(ParseBase base) { 
		...
		this.setAlarmStartTime(base.alarmStartTime); 
		this.setAlarmEndTime(base.alarmEndTime); 
	...
	public Object clone() { 
		...
		base.setAlarmStartTime(this.alarmStartTime); 
		base.setAlarmEndTime(this.alarmEndTime);
